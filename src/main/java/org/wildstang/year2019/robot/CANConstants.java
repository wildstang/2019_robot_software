...
public final class CANConstants {
    public static final int LEFT_DRIVE_TALON = 6;
    public static final int RIGHT_DRIVE_TALON = 3;

    public static final int[] LEFT_DRIVE_VICTORS = {4,5};
    public static final int[] RIGHT_DRIVE_VICTORS = {1,2};
