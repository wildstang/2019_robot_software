...
public class AutoStartPositionEnum {
    ...
    public static final AutoStartPositionEnum CENTER_BACK_PYRAMID = new AutoStartPositionEnum(1,
            "insidePyramidBackCenter", "Inside pyramid, back center");
    public static final AutoStartPositionEnum POSITION2 = new AutoStartPositionEnum(2, "unknown", "Unknown Position");
    public static final AutoStartPositionEnum BACK_LEFT_PYRAMID_INSIDE = new AutoStartPositionEnum(3,
            "insidePyramidBackLeft", "Inside pyramid, back left");
    public static final AutoStartPositionEnum BACK_RIGHT_PYRAMID_INSIDE = new AutoStartPositionEnum(4,
            "insidePyramidBackRight", "Inside Pyramid, back right");
    public static final AutoStartPositionEnum BACK_RIGHT_PYRAMID_OUTSIDE = new AutoStartPositionEnum(5,
            "outsidePyramidBackRight", "Outside Pyramid, back right");
    public static final AutoStartPositionEnum BACK_LEFT_PYRAMID_OUTSIDE = new AutoStartPositionEnum(6,
            "outsidePyramidBackLeft", "Outside Pyramid, back left");
