...
public enum WSInputs implements Inputs {
    ...
    DRV_THROTTLE("Driver throttle", WSInputType.JS_JOYSTICK,
            new WsJSJoystickInputConfig(0, JoystickConstants.LEFT_JOYSTICK_Y),
            getLogging()), DRV_HEADING("Driver heading", WSInputType.JS_JOYSTICK,
                    new WsJSJoystickInputConfig(0, JoystickConstants.RIGHT_JOYSTICK_X),
                    getLogging()), DRV_LEFT_X("Driver left X", WSInputType.JS_JOYSTICK,
                            new WsJSJoystickInputConfig(0, JoystickConstants.LEFT_JOYSTICK_X),
                            getLogging()), DRV_RIGHT_Y("Driver right Y", WSInputType.JS_JOYSTICK,
    ...
    DRV_BUTTON_4("Driver button 4", WSInputType.JS_BUTTON, new WsJSButtonInputConfig(0, 3), getLogging()), DRV_BUTTON_5(
            "Driver Turret Mode", WSInputType.JS_BUTTON, new WsJSButtonInputConfig(0, 4), getLogging()), DRV_BUTTON_6(
                    "Driver Shift", WSInputType.JS_BUTTON, new WsJSButtonInputConfig(0, 5), getLogging()), DRV_BUTTON_7(
                            "Driver Intake Nose Control", WSInputType.JS_BUTTON, new WsJSButtonInputConfig(0, 6),
                            getLogging()), DRV_BUTTON_8("Driver Turbo", WSInputType.JS_BUTTON,
                                    new WsJSButtonInputConfig(0, 7), getLogging()), DRV_BUTTON_12_PG("Pistol Grip",
                                            WSInputType.JS_BUTTON, new WsJSButtonInputConfig(0, 11), getLogging()),
    ...
    MAN_LEFT_JOYSTICK_Y("Manip Intake in_out", WSInputType.JS_JOYSTICK,
            ...
            getLogging()), FLYWHEEL_LOW("Flywheel Low Speed", WSInputType.JS_DPAD_BUTTON,
                    new WsJSButtonInputConfig(1, JoystickConstants.DPAD_X_LEFT),
                    getLogging()), FLYWHEEL_MEDIUM("Flywheel Medium Speed", WSInputType.JS_DPAD_BUTTON,
                            new WsJSButtonInputConfig(1, JoystickConstants.DPAD_Y_UP),
                            getLogging()), FLYWHEEL_HIGH("Flywheel High Speed", WSInputType.JS_DPAD_BUTTON,
                                    new WsJSButtonInputConfig(1, JoystickConstants.DPAD_X_RIGHT),
                                    getLogging()), MAN_BUTTON_1("Manip Deploy Climber Arm", WSInputType.JS_BUTTON,
                                            new WsJSButtonInputConfig(1, 0),
                                            getLogging()), MAN_BUTTON_2("Manip Deploy Climber Hook",
                                                    WSInputType.JS_BUTTON, new WsJSButtonInputConfig(1, 1),
                                                    getLogging()), MAN_BUTTON_3("Manip Flywheel on_off",
                                                            WSInputType.JS_BUTTON, new WsJSButtonInputConfig(1, 2),
                                                            getLogging()), MAN_BUTTON_4("Manip Shot Distance",
                                                                    WSInputType.JS_BUTTON,
                                                                    new WsJSButtonInputConfig(1, 3),
                                                                    getLogging()), MAN_BUTTON_5("Manip Intake Nose",
                                                                            WSInputType.JS_BUTTON,
                                                                            new WsJSButtonInputConfig(1, 4),
                                                                            getLogging()), MAN_BUTTON_6(
                                                                                    "Manip Shooter Hood",
                                                                                    WSInputType.JS_BUTTON,
                                                                                    new WsJSButtonInputConfig(1, 5),
                                                                                    getLogging()), MAN_BUTTON_7(
                                                                                            "Manip Deploy Intake",
                                                                                            WSInputType.JS_BUTTON,
                                                                                            new WsJSButtonInputConfig(1,
                                                                                                    6),
                                                                                            getLogging()), MAN_BUTTON_8(
                                                                                                    "Manip Shoot",
                                                                                                    WSInputType.JS_BUTTON,
                                                                                                    new WsJSButtonInputConfig(
                                                                                                            1, 7),
                                                                                                    getLogging()), MAN_BUTTON_9(
                                                                                                            "Override",
                                                                                                            WSInputType.JS_BUTTON,
                                                                                                            new WsJSButtonInputConfig(
                                                                                                                    1,
                                                                                                                    8),
                                                                                                            getLogging()), MAN_BUTTON_10(
                                                                                                                    "Manipulator button 10",
                                                                                                                    WSInputType.JS_BUTTON,
                                                                                                                    new WsJSButtonInputConfig(
                                                                                                                            1,
                                                                                                                            9),
    ...
    TARGET_BOTTOM("Target Bottom", WSInputType.REMOTE_ANALOG, new WsRemoteAnalogInputConfig("remoteIO"),
            getLogging()), TARGET_CENTER("Target Center", WSInputType.REMOTE_ANALOG,
                    new WsRemoteAnalogInputConfig("remoteIO"), getLogging()), VISION_ANGLE("Vision Angle",
                            WSInputType.REMOTE_ANALOG, new WsRemoteAnalogInputConfig("remoteIO"),
                            getLogging()), VISION_DISTANCE("Vision Distance", WSInputType.REMOTE_ANALOG,
                                    new WsRemoteAnalogInputConfig("remoteIO"), getLogging()),

    MOTION_PROFILE_CONTROL("MotionProfileConfig", WSInputType.MOTION_PROFILE_CONTROL, new WsMotionProfileConfig(),
            getLogging()), INTAKE_BOLDER_SENSOR("Intake Ball Staging", WSInputType.SWITCH,
    ...
    RIGHT_ARM_TOUCHING("Right Lift arm touching", WSInputType.SWITCH, new WsDigitalInputConfig(7, false),
            getLogging()), LEFT_ARM_TOUCHING("Left Lift arm touching", WSInputType.SWITCH,
